...
public class XMLBuilder {
	...
	public static String buildDataRequest(XMLDataRequest xmlDataRequest){
		...
		if(xmlDataRequest.getTask() != null){
			sb.append("<task>" +
					"<sequenceID>" + xmlDataRequest.getTask().getSequenceNo() + "</sequenceID>" +
					"<action>" + actionToString(xmlDataRequest.getTask().getAction()) + "</action>" +
					"</task>");
		}
		sb.append("</nbp>");		
	...
	public static String checkNull(long a) {
		if ((a == 0)) {
			return "";
		}
